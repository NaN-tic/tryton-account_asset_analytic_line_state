...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-account_asset_analytic_line_state',
    download_url='https://github.com:nantic/trytond-account_asset_analytic_line_state.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_asset_analytic_line_state.git'
    },
    classifiers=[
